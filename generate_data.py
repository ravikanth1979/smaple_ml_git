...
class TimeSeriesData:
    ...
    def reshape_data(self):
        self.x = np.reshape([self.y[i:i + self.num_prev] for i in range(self.num_datapoints)], (-1, self.num_prev))
    ...
    def train_test_split(self):
        ...
        self.data = [self.X_train, self.X_test, self.y_train,self.y_test] = self.x[:-test_size], self.x[-test_size:], self.y[:-test_size], self.y[-test_size:]
...
fixed_ar_coefficients = {2: [ 0.46152873, -0.29890739],
    ...
    10: [-0.10958935, -0.34564819,  0.3682048,   0.3134046,  -0.21553732,  0.34613629,0.41916508,  0.0165352,   0.14163503, -0.38844378],
    20: [ 0.1937815,   0.01201026,  0.00464018, -0.21887467, -0.20113385, -0.02322278,0.34285319, -0.21069086,  0.06604683, -0.22377364,  0.11714593, -0.07122126,-0.16346554,  0.03174824,  0.308584,    0.06881604,  0.24840789, -0.32735569,0.21939492, 0.3996207 ]}
